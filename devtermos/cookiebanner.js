    ...
    Cookiebanner.prototype = {
        ...
        init: function(opts) {
            ...
            var default_text = 'Usamos cookies para melhorar sua experiência. ' +
                'Ao continuar a visitar este site, você concorda com o uso de cookies.';
            ...
            this.default_options = {
                ...
                closeText: '&#10006;',
                closeStyle: 'float:right;margin: 10px 0px 10px 10px;cursor: pointer;padding: 7px 16px;background-color: #386728;',
                closePrecedes: true,
                cookiePath: '/',
                cookieDomain: null,
                cookieSecure: false,
